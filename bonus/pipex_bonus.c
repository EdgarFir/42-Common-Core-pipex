...
/*   Updated: 2025/05/12 00:36:36 by edfreder         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex_bonus.h"

void	exec_pipeline(t_cmd *pids_lst, char **argv, char **envp, int unlink)
{
	t_cmd	*curr;
	char	*cmd_path;
	int		i;
	...
	proc_father(pids_lst, 1);
}

void	here_doc(char **argv, int argc, char **envp)
{
	int		temp_fd;
	char	*arg[6];
	t_cmd	*lst;
